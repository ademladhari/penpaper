...
import { GetInventoryData } from '../../getdata/GetData';

function InventoryAmounts() {
 ...
 {amounts.map((amount, index) => (
  <div key={index} className='flex items-center '>
    ...
    {inputModes[index] ? (
      ...
      > {parseFloat(amount).toLocaleString('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 3 })}</div>
